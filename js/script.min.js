...
$(window).on('scroll',function(){counter();});function initialize(){var latitude=$("#map-canvas").attr("data-latitude");var longitude=$("#map-canvas").attr("data-longitude");var coords=[latitude,longitude];var zoomLevel=3;var map=L.map("map-canvas",{scrollWheelZoom:false}).setView(coords,zoomLevel);var tiles="http://acetate.geoiq.com/tiles/acetate-hillshading/";L.tileLayer(tiles+"{z}/{x}/{y}.png",{attribution:'Map data &copy; <a href="http://openstreetmap.org">OpenStreetMap</a> contributors, <a href="http://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery &copy; <a href="http://FortiusOne.com">FortiusOne</a> and <a href="http://stamen.com">Stamen</a>',maxZoom:18}).addTo(map);}
